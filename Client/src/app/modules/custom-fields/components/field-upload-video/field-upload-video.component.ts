...
@Component({
  selector: 'app-field-upload-video',
  templateUrl: './field-upload-video.component.html',
  styleUrls: ['./field-upload-video.component.scss']
})
export class FieldUploadVideoComponent implements OnChanges {
  @Input() customField;
  @Input() view = false;
  @Input() roles;
